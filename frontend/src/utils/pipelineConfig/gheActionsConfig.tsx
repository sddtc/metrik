...
export const GHE_ACTIONS_CONFIG: PipelineConfig[] = [
	{
		gutter: 24,
		children: [
			{
				span: 8,
				name: "ghe",
				label: "GitHub Enterprise Base URL",
				placeholder: "e.g: https://git.company.com/api/v3/repos",
				rules: [{ required: true, whitespace: true, message: "Please input the URL of your GHE" }],
			},
		],
	},
	{
